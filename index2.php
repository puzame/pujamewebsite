...
<div id="contact" class="container">
  ...
  <div class="row">
    <div class="col-md-4">
      ...
      <p><span class="glyphicon glyphicon-map-marker"></span>Lalitpur,Godawari</p>
      <p><span class="glyphicon glyphicon-phone"></span>Phone: 9889356789</p>
      <p><span class="glyphicon glyphicon-envelope"></span>Email: onlinestore@gmail.com</p>
    </div>
      <div class="row">
        <div class="col-md-12 form-group">
          <button class="btn pull-right" type="submit" style="background-color:#000;color:#ffffff;width:100%;height:50px;border-radius:5px;">Thank you for visit us</button>
        </div>
      </div>
    </div>
  </div>
